...
return  array(
	...
	'DISPATCH_NAME'			    =>	'IXCore',	// 默认的Dispatcher名称
	// URL模式： 0 普通模式 1 PATHINFO 2 REWRITE 3 兼容模式
	'URL_MODEL'					=>	3,		// 默认为PATHINFO 模式，提供最好的用户体验和SEO支持
	// PATHINFO 模式
	...
	/* 插件设置 */
	'IXCORE_PLUGIN_ON'			=>	false,	// 默认启用插件机制
	...
	/* 系统变量设置 */
	'VAR_PATHINFO'				=>	'i',	// PATHINFO 兼容模式获取变量例如 ?s=/module/action/id/1 后面的参数取决于PATH_MODEL 和 PATH_DEPR
	...
	/* SESSION设置 */
	'SESSION_NAME'				=>	'IxCID',		// 默认Session_name 如果需要不同项目共享SESSION 可以设置相同
	'SESSION_PATH'				=>	'',			// 采用默认的Session save path
	'SESSION_TYPE'				=>	'File',			// 默认Session类型 支持 DB 和 File
	'SESSION_EXPIRE'			=>	600,		// 默认Session有效期
	'SESSION_TABLE'				=>	'ixcore_session',	// 数据库Session方式表名
	...
	'DB_FIELDTYPE_CHECK'          =>    true,          //缓存数据表类型
	...
	'DATA_CACHE_TABLE'		=>	'ixcore_cache',	// 数据缓存表 当使用数据库缓存方式时有效
	...
	/* 模板引擎设置 */
	'TMPL_ENGINE_TYPE'		=>	'IXCore',		// 默认模板引擎 以下设置仅对使用IXCore模板引擎有效
	...
	/* Cookie设置 */
	'COOKIE_EXPIRE'				=>	3000000,		// Coodie有效期
	'COOKIE_DOMAIN'		    	=>	'',	// Cookie有效域名
	'COOKIE_PATH'				=>	'/',			// Cookie路径
	'COOKIE_PREFIX'				=>	'IxC_', // Cookie前缀 避免冲突
    'COOKIE_SECRET_KEY'         =>   '',  // Cookie 加密Key

	/* 分页设置 */
	'PAGE_NUMBERS'				=>	9,			// 分页显示页数
	...
	/* 其它设置 */
	'AUTO_LOAD_PATH'			=>	'IXCore.Util.',	//	 __autoLoad 的路径设置 当前项目的Model和Action类会自动加载，无需设置 注意搜索顺序
    ...
    'TOKEN_NAME'                =>  'ixc_token',    // 令牌验证的表单隐藏字段名称
