...
{//类定义开始
   ...
   public function read($sessID) { 
       // fetch session-data 
       $res = mysql_query("SELECT session_data AS d FROM ".$this->sessionTable." WHERE session_id = '$sessID'   AND session_expires >".NOW,$this->dbHandle); 
   ...
   public function gc($sessMaxLifeTime) { 
       // delete old sessions 
       mysql_query("DELETE FROM ".$this->sessionTable." WHERE session_expires < ".NOW,$this->dbHandle); 
