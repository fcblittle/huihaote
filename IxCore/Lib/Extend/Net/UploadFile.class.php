        ...
        if($this->thumb) {
            ...
            if(false !== $image) {
                ...
                for($i=0,$len=count($thumbWidth); $i<$len; $i++) {
                    $thumbname = $thumbPath.
                    (isset($thumbPrefix[$i])?$thumbPrefix[$i]:'').
                    substr($file['savename'],0,strrpos($file['savename'], '.')).
                    (isset($thumbSuffix[$i])?$thumbSuffix[$i]:'').
                    '.'.$file['extension'];
                    Image::thumb($filename, 'jpg', $thumbname, $thumbWidth[$i], $thumbHeight[$i], true, '');
                }
            }
        }
        if($this->zipImags) {
