...
<div id="table">
<h3><?php echo ($name); ?>资料设置</h3>

<form action="/index.php/System/config" method="post">
...
<td>
<select name="name[]">
<option value="sorder" <?php if(($vo['name'])  ==  "sorder"): ?>selected="selected"<?php endif; ?>>销售</option>
<option value="service1" <?php if(($vo['name'])  ==  "service1"): ?>selected="selected"<?php endif; ?>>维修人</option>
<option value="service2" <?php if(($vo['name'])  ==  "service2"): ?>selected="selected"<?php endif; ?>>维修类型</option>
</select>
<input type="hidden" name="id[]" value="<?php echo ($vo['id']); ?>" />
</td>
<td><input name="intro[]" type="text" value="<?php echo ($vo['intro']); ?>" /></td>
<td><input name="value[]" type="text" style="width:100px;" value="<?php echo ($vo['value']); ?>" />　%</td>
</tr><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
<tr>
<td>
<select name="name[]">
<option value="sorder">销售</option>
<option value="service1">维修人</option>
<option value="service2">维修类型</option>
</select>
</td>
<td><input name="intro[]" type="text" value="" /></td>
...
$("#linebox tr:last").find('input').each(function(x){
$(this).val('');
});
}
</script>
