...
<td>
<?php if(isset($can_do[$mname]['view'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Service/audit/view/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>/url/audit">查 看</a><?php endif; ?>
<?php if(isset($can_do[$mname]['edit'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Service/audit/edit/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>/url/audit">修 改</a><?php endif; ?>
<?php if(isset($can_do[$mname]['delete'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Service/audit/delete/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>/url/audit">删 除</a><?php endif; ?>
&nbsp;┊&nbsp;
</td>
