...
<div id="table">
<h3>银行明细 列表</h3>
<form action="/index.php/Financial/viewBank/" style="padding-bottom:10px;">
来 源：
...
<?php echo ($name); ?>:<?php echo ($account); ?>　　　　
开户人：<?php echo ($holder); ?>　　　　
开户银行：<?php echo ($address); ?>　　　　
开户时间：<?php echo (date("Y-m-d", $time)); ?>
</td>
</tr>
<tr>
<table cellpadding="2" cellspacing="1" border="0" class="needhover">
...
<td <?php if(($vo['type'])  ==  "financial"): ?>title="采购、销售、售后"<?php endif; ?>>
<?php switch($vo['type']): ?><?php case "daily":  ?>日常费用<?php break;?>
<?php case "worker":  ?>员工费用<?php break;?>
<?php case "allot":  ?>银行调拨<?php break;?>
<?php case "financial":  ?>收支费用<?php break;?>
