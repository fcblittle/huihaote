...
<div id="table">
<h3>库存出入记录<span><?php if(isset($can_do['Stock']['audit'])): ?>(点击未确认状态可进行确认审核)<?php endif; ?></span></h3>

<script type="text/javascript" src="/./Tpl/default/Public/JS/datebox.js"></script>

<form action="/index.php/Stock/index/" style="margin-bottom:10px;" >
<select name="gid">
...
<option value="out" <?php if(($type)  ==  "out"): ?>selected="selected"<?php endif; ?> >出库记录</option>
<option value="in" <?php if(($type)  ==  "in"): ?>selected="selected"<?php endif; ?> >入库记录</option>
</select>
...
<td>
<?php if(($can_manage)  ==  "1"): ?><?php if(isset($can_do['Stock']['view'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Stock/view/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">查 看</a><?php endif; ?>
<?php if(isset($can_do['Stock']['edit'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Stock/edit/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">修 改</a><?php endif; ?>
<?php if(isset($can_do['Stock']['delete'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Stock/delete/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">删 除</a><?php endif; ?>
&nbsp;┊&nbsp;<?php endif; ?>
</td>
