...
<form action="/index.php/Home/intro" method="post" enctype="multipart/form-data">
...
<tr>
<td width="100">姓 名</td>
<td class="tf"><input type="text" style="width:250px;" readonly="readonly" value="<?php echo ($name); ?>" /></td>
</tr>
<tr>
<td>编 号</td>
<td class="tf"><input type="text" style="width:250px;" readonly="readonly" value="<?php echo ($num); ?>" /></td>
</tr>
<tr>
<td>生 日</td>
