...
<form action="/index.php/Porder/addSwap" method="post" enctype="multipart/form-data">
...
cgrk-<input type="text" id="num" style="width:180px;" autocomplete="off" onkeyup="getOrders(this)" name="num" />
<style>
