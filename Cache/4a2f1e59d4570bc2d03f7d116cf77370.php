...
<form action="/index.php/Goods/edit" method="post" enctype="multipart/form-data">
...
<?php if(is_array($groups)): ?><?php $i = 0;?><?php $__LIST__ = $groups?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = (($i % 2 )==0)?><option value="<?php echo ($vo['gid']); ?>" <?php if(in_array($vo['gid'], $groupGood)){ echo 'selected="selected"'; }?>><?php echo ($vo['levelstr']); ?> <?php echo ($vo['name']); ?></option><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
</select>
</td>
</tr>
<tr>
<td>型 号</td>
<td class="tf"><input type="text" style="width:250px;" name="model" value="<?php echo ($model); ?>" /></td>
</tr>
<tr>
<td>预售价格</td>
...
<tr>
<td>采购价格</td>
<td class="tf"><input type="text" style="width:250px;" name="cost" value="<?php echo (showPrice($cost)); ?>" /></td>
</tr>
<tr>
<td>数量单位</td>
<td class="tf"><input type="text" style="width:250px;" name="unit" value="<?php echo ($unit); ?>" /></td>
</tr>
...
<input type="button" class="button" onclick="location.href='/index.php/Goods/index'" value="返 回" />
