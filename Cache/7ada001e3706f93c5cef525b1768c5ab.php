...
<td><?php if(($vo['money'])  >  "0"): ?><?php echo (showPrice($vo['money'])); ?><?php endif; ?></td>
<td><?php if(($vo['money'])  <  "0"): ?><?php echo (showPrice($vo['money'])); ?><?php endif; ?></td>
<td><?php echo ($vo['comment']); ?></td>
<td>
<a href="/index.php/Stock/edit/order/<?php echo ($vo['order']); ?>/come/<?php echo ($vo['come']); ?>/goods/<?php echo ($vo['goods']); ?>">查 看</a>
<?php if($vo['hand']): ?><?php if(isset($can_do['Financial']['editDebt'])): ?><a href="/index.php/Financial/editDebt/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">修 改</a><?php endif; ?><?php endif; ?>
</td>
