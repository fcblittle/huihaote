...
<form action="/index.php/Client/add/url/<?php echo ($url); ?>" method="post" enctype="multipart/form-data">
...
<?php if(($url)  ==  ""): ?><input type="button" class="button" onclick="location.href='/index.php/Client/index'" value="返 回" />
<?php else: ?>
