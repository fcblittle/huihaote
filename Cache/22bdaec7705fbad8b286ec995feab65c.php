...
<h3>个人信箱</h3>
<div class="tab">
`   <a href="/index.php/Home/mail" class="action">收件箱<span class="red fb"></span></a>
<a href="/index.php/Home/mail/type/send">发件箱<span class="red fb"></span></a>
...
<a href="/index.php/Home/mail/id/all" style="color:#CCC;">全部标记已读</a>&nbsp;|&nbsp;
<a href="/index.php/Home/mail/type/del/id/all" style="color:#CCC;">全部删除</a>
</div>
...
<div class="mailtitle">
<p>
<?php if((is_array($vo)?$vo["read"]:$vo->read)  ==  "0"): ?><span class="red">【NEW】</span><?php endif; ?>
<?php if(isset($vo['newreply'])): ?><span class="red">【新回复】</span><?php endif; ?>
<?php if((is_array($vo)?$vo["system"]:$vo->system)  ==  "1"): ?><b>系统消息：</b><?php endif; ?>
<?php echo ($vo['title']); ?>
</p>
<span class="info">
<?php if((is_array($vo)?$vo["system"]:$vo->system)  ==  "0"): ?>发件人：<?php echo ($vo['writer']['name']); ?>&nbsp; | &nbsp;<?php endif; ?>
...
<?php if((is_array($vo)?$vo["system"]:$vo->system)  ==  "0"): ?><dl class="reply">
