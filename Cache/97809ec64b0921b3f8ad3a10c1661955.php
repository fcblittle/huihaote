...
<td>
<?php if(isset($can_do[$mname]['viewSwap'])): ?><a href="/index.php/Sorder/viewSwap/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">查 看</a><?php endif; ?>
<?php if(isset($can_do[$mname]['editSwap'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Sorder/editSwap/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">修 改</a><?php endif; ?>
<?php if(isset($can_do[$mname]['delSwap'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Sorder/delSwap/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">删 除</a><?php endif; ?>
&nbsp;┊&nbsp;
</td>
...
<?php if(isset($can_do[$mname]['addSwap'])): ?><input type="button" class="button" onclick="location.href='/index.php/Sorder/addSwap/do/1'" value="添 加" /> &nbsp;<?php endif; ?>
<!--
