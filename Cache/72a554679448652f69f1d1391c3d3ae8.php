...
<form action="/index.php/Sorder/editSwap" method="post" enctype="multipart/form-data">
...
.orders {border:1px solid #7F9DB9; position:absolute; z-index:100; background:#FFFFFF; width:200px; left:158px; top:180px;}
...
//查询
$.post("/index.php/Sorder/swap/do/getOrders",
{num:'xsck-'+order},
function(data){
data = eval('('+data+')');
$(".orders").html('');
...
$.post("/index.php/Sorder/swap/do/getProducts",
