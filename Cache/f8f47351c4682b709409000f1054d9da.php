...
<div id="table">
<div id="ajaxmsg"></div>
<h3>货品分类管理<span></span></h3>
<script type="text/javascript" src="/./Tpl/default/Public/JS/tree.js"></script>
<table cellpadding="2" cellspacing="0" border="0">
<tr class="white">
<td>
<ul id="treebox">
<?php if(is_array($list)): ?><?php $i = 0;?><?php $__LIST__ = $list?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = (($i % 2 )==0)?><li class="level<?php echo ($vo['level']); ?>" id="id<?php echo ($vo['id']); ?>" <?php if($vo['level'] >= 2) echo 'style="display:none;"'; ?>>
<span class="txt"><?php echo (html($vo['name'])); ?><?php if(($vo['lock'])  !=  "0"): ?><input type="hidden" /><?php endif; ?></span>
<span class="cbox">
<a class="but add" href="javascript:add(<?php echo ($vo['id']); ?>);">&nbsp;</a><?php if(($vo['lock'])  ==  "0"): ?><a class="but del" href="javascript:del(<?php echo ($vo['id']); ?>);">&nbsp;</a><?php endif; ?>
</span>
...
ajax("/index.php/Goods/type/type/delete", {id:id}, 'post', function(data){
...
//ajax get
if(id){
var url = "/index.php/Goods/type/type/edit";
...
var url = "/index.php/Goods/type/type/add";
