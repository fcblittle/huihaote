...
<h1 style="text-align:center; font-size:20px; margin:5px 0px;">采购单</h1><br />

<div style="height:30px; line-height:30px; width:100%; margin:5px;">
<div style="width:40%; float:left;">供应商名称：<?php echo ($supply['name']); ?></div>
<div style="width:28%; float:left; text-align:center;">开单日期：<?php echo date("Y-m-d", $stock['time']); ?>　</div>
