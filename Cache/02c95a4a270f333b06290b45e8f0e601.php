...
<form id="Search" action="/index.php/Porder/statistics" method="get" style="background:#FFF; padding:10px; margin-top:20px; width:100%;">
姓 名：
...
<td>
<?php if(isset($can_do[$mname]['view'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Porder/view/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">查 看</a><?php endif; ?>
<!--<?php if(isset($can_do[$mname]['edit'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Porder/edit/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">修 改</a><?php endif; ?>
<?php if(isset($can_do[$mname]['delete'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Porder/delete/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">删 除</a><?php endif; ?>-->
&nbsp;┊&nbsp;
</td>
</tr><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
<tr class="white page">
<td colspan="4" style="text-align: left;">
总金额：<?php echo (showPrice($total+$taxTotal-$reback)); ?>　
含税采购：<?php echo (showPrice($taxTotal+$haveTax-$taxreback)); ?>　
退货：<?php echo (showPrice($reback)); ?>　<br />
差额：<?php echo (showPrice($total+$taxTotal-$reback)); ?>　
</td>
<td colspan="5" class="tr"><?php echo ($page); ?></td>
</tr>
</table>
<!--
<?php if(isset($can_do[$mname]['add'])): ?><input type="button" class="button" onclick="location.href='/index.php/Porder/add/do/1'" value="添 加" /> &nbsp;<?php endif; ?>
...
location.href= '/index.php/Porder/printStatistics' + search + start + end + cors;
}
