...
<td><?php echo (date('Y-m-d　H:i',is_array($vo)?$vo["rtime"]:$vo->rtime)); ?></td>
<td>
<?php if(($vo['audit'])  ==  "0"): ?>未审核
<?php else: ?>
<?php if(($vo['audit'])  >  "0"): ?>通过
<?php else: ?>
拒绝<?php endif; ?><?php endif; ?>
</td>
<td>
<?php if(isset($can_do[$mname]['viewSwap'])): ?><a href="/index.php/Porder/viewSwap/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">查 看</a><?php endif; ?>
<?php if(isset($can_do[$mname]['editSwap'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Porder/editSwap/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">修 改</a><?php endif; ?>
<?php if(isset($can_do[$mname]['delSwap'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Porder/delSwap/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">删 除</a><?php endif; ?>
&nbsp;┊&nbsp;
</td>
</tr><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
<tr class="white page">
<td colspan="<?php if(($mname)  ==  "Sorder"): ?>8<?php else: ?>7<?php endif; ?>" class="tr"><?php echo ($page); ?></td>
</tr>
</table>
<?php if(isset($can_do[$mname]['addSwap'])): ?><input type="button" class="button" onclick="location.href='/index.php/Porder/addSwap/do/1'" value="添 加" /> &nbsp;<?php endif; ?>
<!--
<?php if(!isset($search)): ?><input class="button" type="button" onclick="openSearch()" value="搜 索" />
<?php else: ?>
<input class="button" onclick="location.href='/index.php/Porder/<?php if(isset($url)): ?><?php echo ($url); ?><?php else: ?>index<?php endif; ?>'" type="button" value="返 回" /><?php endif; ?>
-->

<form id="Search" action="/index.php/Porder/index" method="get" style="border:#CCC solid 1px; background:#FFF; padding:10px; margin-top:20px; width:300px; display:none;">
