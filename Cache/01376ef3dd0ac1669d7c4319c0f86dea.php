...
<div id="table">
<h3><?php echo ($tname); ?>未审核列表</h3>
<table cellpadding="2" cellspacing="1" border="0" class="needhover">
<tr>
<th>单 号</th>
<th><?php if(($abs)  ==  "1"): ?>供应商<?php else: ?>客 户<?php endif; ?></th>
<?php if(($mname)  ==  "Sorder"): ?><th>销售人员</th><?php endif; ?>
<?php if(($mname)  ==  "Porder"): ?><th>采购人员</th><?php endif; ?>
<th width="80">申请人</th>
...
<td>
<?php if(isset($can_do[$mname]['view'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Morder/audit/view/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>/url/audit">查 看</a><?php endif; ?>
<?php if(isset($can_do[$mname]['edit'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Morder/audit/edit/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>/url/audit">修 改</a><?php endif; ?>
<?php if(isset($can_do[$mname]['delete'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Morder/audit/delete/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>/url/audit">删 除</a><?php endif; ?>
&nbsp;┊&nbsp;
</td>
</tr><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
<tr class="white page">
<td colspan="<?php if($mname=='Sorder' || $mname=='Porder'){ echo 7; }else{ echo 6; }?>" class="tr"><?php echo ($page); ?></td>
</tr>
</table>
