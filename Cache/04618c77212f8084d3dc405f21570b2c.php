...
<div id="table">
<h3>配件管理列表</h3>
<form id="Search" action="/index.php/Service/parts" method="get" style="background:#FFF; padding:10px; margin-top:-30px; width:600px;">
姓 名：<input name="search" id="search" style="width:100px;" type="input" value="<?php echo ($search); ?>" />　
...
<td><?php echo (is_array($vo)?$vo["operator"]:$vo->operator); ?></td>
<td><?php echo (date('Y-m-d', is_array($vo)?$vo["time"]:$vo->time)); ?></td>
<td><?php echo (is_array($vo)?$vo["comment"]:$vo->comment); ?></td>
<td>
<?php if(!$vo['audit']): ?><?php if(isset($can_do['Service']['editParts'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Service/editParts/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">修 改</a><?php endif; ?>
<?php else: ?>
<?php if(isset($can_do['Service']['viewParts'])): ?><a href="/index.php/Service/viewParts/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">查 看</a><?php endif; ?>
<?php if(($vo['status'])  ==  "1"): ?><?php if(isset($can_do['Service']['backParts'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Service/backParts/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">退 回</a><?php endif; ?><?php endif; ?><?php endif; ?>
<?php if(isset($can_do['Service']['deleteParts'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Service/deleteParts/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">删 除</a><?php endif; ?>
</td>
...
<?php if(isset($can_do['Service']['addParts'])): ?><input type="button" class="button" onclick="location.href='/index.php/Service/addParts'" value="添 加" /> &nbsp;<?php endif; ?>
...
location.href='/index.php/Service/audit/id/'+id;
}
}
