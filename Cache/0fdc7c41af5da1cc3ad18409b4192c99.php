...
<a href="/index.php/Home/mail/type/new" class="action">+新邮件</a>
</div>

<form action="/index.php/Home/mail" method="post">
...
function searchUser(){
ajax("/index.php/User/index/search/1/all/1", {search:1}, 'post', function(data){
if(data.status == 1){
var html = '';
for(x in data.data){
