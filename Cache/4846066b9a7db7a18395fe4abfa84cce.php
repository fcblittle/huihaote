...
<div id="table">
<h3>数据表优化<span>(对于频繁删除或变更数据，应该在每个月进行数据冗余清理。)</span></h3>

<div>
当前数据表冗余数据为：<?php echo ($free); ?> 字节
</div>
<?php if(($free)  !=  "0"): ?><input type="button" class="button" onclick="location.href='/index.php/System/optimize/size/<?php echo ($free); ?>'" value="优 化" /><?php endif; ?>
</div>
</div>
</div>
</div>
