...
<h3>客户列表</h3>
<div>
<select style="margin-bottom:10px;" onchange="location.href='/index.php/Client/index/type/'+this.value;">
...
<td>
<?php if(isset($can_do['Client']['view'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Client/view/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">查 看</a><?php endif; ?>
<?php if(isset($can_do['Client']['edit'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Client/edit/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">修 改</a><?php endif; ?>
<?php if(isset($can_do['Client']['delete'])): ?>&nbsp;┊&nbsp;<a href="/index.php/Client/delete/id/<?php echo (is_array($vo)?$vo["id"]:$vo->id); ?>">删 除</a><?php endif; ?>
&nbsp;┊&nbsp;
</td>
</tr><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
<tr class="white page">
<td colspan="3" class="tr"><?php echo ($page); ?></td>
</tr>
</table>
<?php if(isset($can_do['Client']['add'])): ?><input type="button" class="button" onclick="location.href='/index.php/Client/add/type/<?php echo ($type); ?>'" value="添 加" /> &nbsp;<?php endif; ?>
<?php if(!isset($search)): ?><input class="button" type="button" onclick="openSearch()" value="搜 索" />
<?php else: ?>
<input class="button" onclick="location.href='/index.php/Client/index'" type="button" value="返 回" /><?php endif; ?>

<form id="Search" action="/index.php/Client/index" method="get" style="border:#CCC solid 1px; background:#FFF; padding:10px; margin-top:20px; width:300px; display:none;">
<label style="display:block; height:30px;">客户名：<input name="name" style="width:200px;" type="input" /></label>
