...
<form action="/index.php/Financial/daily/" style="padding-bottom:10px;">
经办人：
<select name="user">
...
<?php if(isset($can_do['Financial']['addDaily'])): ?><input type="button" class="button" onclick="location.href='/index.php/Financial/addDaily/type/daily'" value="添 加" /> &nbsp;<?php endif; ?>
...
<?php else: ?>
<span style="color:red;">-<?php echo (showPrice(is_array($vo)?$vo["total"]:$vo->total)); ?></span><?php endif; ?>
</td>
